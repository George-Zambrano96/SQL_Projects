...
--distance between routes from trips that were least taken

Declare @source geography = geography::Point(40.7236589, -74.0641943, 4326)
Declare @destination geography= geography::Point(40.71687, -74.03281, 4326)
